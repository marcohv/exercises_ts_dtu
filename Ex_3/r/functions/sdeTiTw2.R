sdeTiTw2 <- function(X, rerun=FALSE){
    ...
    model$addSystem(dTw1 ~ ( 1/(Cw1*Riw)*(Ti-Tw1) + 1/(Cw1*Rww)*(Tw2-Tw1) + Aw*(1-p)/Cw1*Gv )*dt + exp(p22)*dw2) # Aw*(1-p)/Cw*Gv
    ...
    model$setParameter(  Tw2 = c(init=34  ,lb=10    ,ub=100) )
