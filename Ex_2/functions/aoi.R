...
aoiCos1 <- function(time, longitude, latitude, slope, pAzimuth)
{
...
aoiCos2 <- function(time, longitude, latitude, slope, pAzimuth)
  {
    ## All angle are given in degrees.
    ## slope: is the angle between the normal to the ground surface, and the normal of the panel.
    ## pAzimuth: azimuth of the panel where 0 degrees is due south. + is toward west, - is toward east.
...
#elevRad <- aoiSunElevation(12.525550, aoiSunHourAngle(t,55.791033), aoiSunDeclination(t))
#plot(t,aoiToDeg(elevRad))
